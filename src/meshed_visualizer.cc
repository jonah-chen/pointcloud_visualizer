...
int main(int argc, char *argv[])
{
    ...
    bool mask_updated;
    const m_PointCloud og_cloud = load_mesh(args["pointcloud"], args.find("yz") == args.end());
    
    m_PointCloud cloud = og_cloud; // make a copy of original order for masking purposes
    ...
    HUD hud(renderer.window(), camera, masks);
